...
export const initialFollows: Follow[] = [
  ...
  { followerId: "haru", followingId: "me", createdAt: "2時間前" },
  { followerId: "me", followingId: "rina" },
];
export const initialLikes: Like[] = [
  { userId: "rina", postId: "post-3", createdAt: "12分前" },
];
export const initialPosts: Post[] = [
  ...
  { id: "post-3", author: currentUser, skill: findSkill("floor-back-handspring"), body: "補助ありでバク転の反復！少しずつ怖さがなくなってきました。", createdAt: "昨日", likes: 16, comments: [{ id: "comment-seed-1", author: sampleUsers[2], body: "すごく安定しています！", createdAt: "2時間前" }] },
];
